...
def test_delete_order_by_id_found(mock_mongo_collection):
    order_id = "67a77edeaf970c68f41cc3d3"
    ...
    result = repo.delete_entity(order_id)

    assert result is not None
    assert result is True


def test_delete_order_by_id_not_found(mock_mongo_collection):
    order_id = "67a77edeaf970c68f41cc3d3"
